                ...
                <div className="col-12 col-lg-6 col-xxl-7">
                    <div className="inner">
                        <div className="form-floating">
                            <input type="text" className="form-control" id="order-fname" placeholder="fname" value={orderFirstName} required onChange={(e) => setOrderFirstName(e.target.value)} />
                            <label htmlFor="order-fname"><TextTranslate text='Ad' /> *</label>
                        </div>
                        <div className="form-floating">
                            <input type="text" className="form-control" id="order-lname" placeholder="lname" value={orderLastName} onChange={(e) => setOrderLastName(e.target.value)} />
                            <label htmlFor="order-lname"><TextTranslate text='Soyad' /></label>
                        </div>
                        <div className="form-floating">
                            <input type="text" className="form-control" id="order-address" placeholder="address" value={orderAddress} required onChange={(e) => setOrderAddress(e.target.value)} />
                            <label htmlFor="order-address"><TextTranslate text='Çatdırılma ünvanı' /> *</label>
                        </div>
                        <div className="form-floating">
                            <input type="number" className="form-control" id="order-phone" placeholder="phone" value={orderPhone} required onChange={(e) => setOrderPhone(e.target.value)} />
                            <label htmlFor="order-phone"><TextTranslate text='Telefon' /> *</label>
                        </div>
                        <div className="form-floating">
                            <input type="email" className="form-control" id="order-email" placeholder="email" value={orderEmail} required onChange={(e) => setOrderEmail(e.target.value)} />
